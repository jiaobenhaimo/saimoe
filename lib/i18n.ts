...
const D: Record<string, Entry> = {
  ...
  "rules.contact": { zh: "如有疑问,请联系:微信 cxq13176886951 或 JacquesJiao · QQ 3264930752 · 邮箱 jiaobenhaimo@outlook.com。", en: "Questions? Contact us: WeChat cxq13176886951 or JacquesJiao · QQ 3264930752 · Email jiaobenhaimo@outlook.com.", ja: "ご不明な点は:WeChat cxq13176886951 または JacquesJiao · QQ 3264930752 · メール jiaobenhaimo@outlook.com までご連絡ください。" },
  ...
  "sched.group.h": { zh: "小组赛", en: "Group stage", ja: "予選リーグ" },
  "sched.ko.h": { zh: "淘汰赛", en: "Knockout", ja: "トーナメント" },
  ...
  "sched.cadNom": { zh: "提名截止", en: "Nomination closes", ja: "推薦締切" },
